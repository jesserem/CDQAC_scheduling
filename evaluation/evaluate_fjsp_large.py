...
def eval_all(config: TrainConfig):
    ...
    exps = [
        ...
        # (os.path.join(config.datapath, f'SD1/30x10'), os.path.join(config.datapath, 'gen_data.csv'), 'SD1_30_10', False),
        (os.path.join(config.datapath, f'SD1/40x10'), os.path.join(config.datapath, 'gen_data.csv'), 'SD1_40_10',
         False),
