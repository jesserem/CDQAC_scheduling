...
parser.add_argument('--k_epochs', type=int, default=10, help='Update frequency of each episode')
...
parser.add_argument('--test_method', nargs='+', default=["FIFO",], help='List of heuristic methods for testing')
